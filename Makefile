...
SRCS = srcs/minishell.c srcs/wsh_builtin.c srcs/wsh_builtins.c srcs/get_next_line.c srcs/get_next_line_utils.c srcs/wsh_exec.c srcs/wsh_garbageCollector.c srcs/wsh_parsing/wsh_parse.c srcs/wsh_parsing/wsh_parse_utils.c srcs/wsh_read.c srcs/built_ins/wsh_cd.c srcs/built_ins/wsh_echo.c srcs/built_ins/wsh_env.c srcs/built_ins/wsh_exit.c srcs/built_ins/wsh_export.c srcs/built_ins/wsh_pwd.c srcs/built_ins/wsh_unset.c srcs/wsh_exec_cmd.c
BSRCS = includes/
all : $(NAME)
$(NAME):
	@$(MAKE) -C $(LIBFT_DIR)
